...
const experiences = [
  ...
  },
  {
    ...
    description:
      'Designed STELLAR (RAG/LLM architecture for customer service, published in the Journal of the Brazilian Computer Society) and benchmarked hallucination rates of 7 models across 90,000+ questions.',
  },
];
